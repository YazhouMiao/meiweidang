...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			// sales
			if($sort == 'sales' && $order == 'DESC'){
				$data['sorts'][] = array(
						'text'  => $this->language->get('text_sales'),
						'value' => 'sales-DESC',
						'href'  => $this->url->link('product/category', 'path=' . $this->request->get['path'] . '&sort=sales&order=ASC' . $url)
				);
			} else {
				$data['sorts'][] = array(
						'text'  => $this->language->get('text_sales'),
			...
			// p.date_available
			if($sort == 'p.date_available' && $order == 'DESC'){
				$data['sorts'][] = array(
