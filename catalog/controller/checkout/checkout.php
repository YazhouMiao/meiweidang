...
class ControllerCheckoutCheckout extends Controller {
	public function index() {
		...
		$this->document->addScript('catalog/view/javascript/jquery/icheck/icheck.min.js');
		$this->document->addStyle('catalog/view/javascript/jquery/icheck/skins/square/green.css');
		...
		$data['alipay_in_weixin_url']  = $this->url->link('payment/alipay_in_weixin');
