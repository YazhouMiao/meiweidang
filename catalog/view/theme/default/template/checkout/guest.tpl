  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="firstname" value="<?php echo $firstname; ?>" id="input-payment-firstname" placeholder="<?php echo $text_placeholder_name; ?>" class="form-control" />
      </div>
      <div class="form-group required">
        <label class="control-label" for="input-payment-telephone"><?php echo $entry_telephone; ?></label>
        <input type="text" name="telephone" value="<?php echo $telephone; ?>" id="input-payment-telephone" placeholder="<?php echo $text_placeholder_telephone; ?>" class="form-control" />
      </div>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $text_placeholder_address; ?>" id="input-payment-address-1" class="form-control" />
      </div>
      <?php foreach ($custom_fields as $custom_field) { ?>
...
<div class="buttons">
  <div class="pull-right">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-guest" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg" />
  </div>
</div>
