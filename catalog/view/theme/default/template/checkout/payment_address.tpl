<form class="form-horizontal">
  ...
  <div class="radio">
    <input type="radio" id="payment-address-existing" name="payment_address" value="existing" checked="checked" />
    <label for="payment-address-existing"><?php echo $text_address_existing; ?></label>
  </div>
  <div id="payment-existing" class="clearfix">
    <ul class="payment_address">
       <li id="default-address" data-value="<?php echo $default_address['address_id']; ?>" class="selected col-sm-6">
         <a href="javascript:;" title=""> <?php echo $default_address['firstname']; ?>, <?php echo $default_address['telephone']; ?>, <?php echo $default_address['company']; ?>, <?php echo $default_address['delivery_area_name']; ?>, <?php echo $default_address['address_1']; ?></a>
       </li>
       <?php if (!empty($other_addresses)) { ?>
           <span class="btn btn-primary other-address-btn"><i class="fa fa-chevron-circle-down fa-lg"></i> <?php echo $text_other_address; ?></span>
           <?php foreach ($other_addresses as $address) { ?>
           <li data-value="<?php echo $address['address_id']; ?>" class="col-sm-6">
             <a href="javascript:;" title=""> <?php echo $address['firstname']; ?>, <?php echo $address['telephone']; ?>, <?php echo $address['company']; ?>, <?php echo $address['delivery_area_name']; ?>, <?php echo $address['address_1']; ?></a>
           </li>
           <?php } ?>
       <?php } ?>
    </ul>
  ...
  <?php } ?>
  <div class="radio">
    <input type="radio" id="payment-address-new" name="payment_address" value="new" <?php echo empty($addresses) ? 'checked' : '' ?>/>
  ...
  <div class="clearfix">
    ...
    <div class="radio">
        ...
        <?php $code = $quote['code']; ?>
        <input type="radio" id="shipping-method-<?php echo $quote['code']; ?>" name="shipping_method" value="<?php echo $quote['code']; ?>" checked="checked" />
        <?php } else { ?>
        <input type="radio" id="shipping-method-<?php echo $quote['code']; ?>" name="shipping_method" value="<?php echo $quote['code']; ?>" />
        <?php } ?>
        <label for="shipping-method-<?php echo $quote['code']; ?>"><?php echo $quote['title']; ?> - <?php echo $quote['text']; ?></label>
    </div>
    <?php } ?>
    <?php } else { ?>
    <div class="alert alert-danger no-offset-xs"><?php echo $shipping_method['error']; ?></div>
    <?php } ?>
    <?php } ?>
    <?php } ?>
    </div>
  ...
  <div class="buttons clearfix">
    <div class="pull-right">
      <input type="button" value="<?php echo $button_continue; ?>" id="button-payment-address" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg" />
    </div>
  </div>
</form>
...
$(document).ready(function(){
  ...
  $('input[name=\'payment_address\']').on('ifChanged', function() {
    if (this.value == 'new') {
...
$(function(){
    $('#default-address').siblings("li").hide();
    $('.other-address-btn').on('click', function() {
      $('#default-address').siblings("li").toggle();
    });
    $("#payment-existing").each(function(){
        var i = $(this);
        var p = i.find("ul>li");
        p.click(function(){
