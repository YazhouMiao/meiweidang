...
class ModelCheckoutOrder extends Model {
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			/* myzhou 2015/6/5  删除country/zone
			...
			*/
			...
			return array(
				...
				// myzhou 2015/7/8 add service_zone/delivery_area
				'service_zone_id'         => $order_query->row['service_zone_id'],
				'service_zone_name'       => $order_query->row['service_zone_name'],
				'delivery_area_id'        => $order_query->row['delivery_area_id'],
				'delivery_area_name'      => $order_query->row['delivery_area_name']
			);
		} else {
			return false;
		}
