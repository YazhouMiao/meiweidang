...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_weixin_qrcode'] = $this->language->get('entry_weixin_qrcode');
		...
		// myzhou 2015/6/28 添加商品属性图片大小设置
		$data['entry_image_product_option'] = $this->language->get('entry_image_product_option');
		// end
		...
		// myzhou 2015/6/27 添加配送人员所在群组
		$data['entry_deliverer_group'] = $this->language->get('entry_deliverer_group');
		// end
		$data['entry_default_city_id'] = $this->language->get('entry_default_city_id');
		...
		// myzhou 2015/6/27 添加配送人员所在群组
		$data['help_deliverer_group'] = $this->language->get('help_deliverer_group');
		// end
		...
		// myzhou 2015/6/28 添加商品选项图片大小设置
		if (isset($this->error['image_product_option'])) {
			$data['error_image_product_option'] = $this->error['image_product_option'];
		} else {
			$data['error_image_product_option'] = '';
		}
		// end
		...
		if (isset($this->request->post['config_default_city_id'])) {
			$data['config_default_city_id'] = $this->request->post['config_default_city_id'];
		} else {
			$data['config_default_city_id'] = $this->config->get('config_default_city_id');
		}
		...
		// myzhou 2015/6/27 添加配送人员所在群组
		if (isset($this->request->post['config_customer_group_id'])) {
			$data['config_deliverer_group_id'] = $this->request->post['config_deliverer_group_id'];
		} else {
			$data['config_deliverer_group_id'] = $this->config->get('config_deliverer_group_id');
		}
		// end
		...
		if (isset($this->request->post['config_weixin_qrcode'])) {
			$data['config_weixin_qrcode'] = $this->request->post['config_weixin_qrcode'];
		} else {
			$data['config_weixin_qrcode'] = $this->config->get('config_weixin_qrcode');
		}
		
		if (isset($this->request->post['config_weixin_qrcode']) && is_file(DIR_IMAGE . $this->request->post['config_weixin_qrcode'])) {
			$data['weixin_qrcode'] = $this->model_tool_image->resize($this->request->post['config_weixin_qrcode'], 100, 100);
		} elseif ($this->config->get('config_weixin_qrcode') && is_file(DIR_IMAGE . $this->config->get('config_weixin_qrcode'))) {
			$data['weixin_qrcode'] = $this->model_tool_image->resize($this->config->get('config_weixin_qrcode'), 100, 100);
		} else {
			$data['weixin_qrcode'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		...
		// myzhou 2016/6/28 添加商品选项图片大小设置
		if (isset($this->request->post['config_image_product_option'])) {
			$data['config_image_product_option_width'] = $this->request->post['config_image_product_option_width'];
		} else {
			$data['config_image_product_option_width'] = $this->config->get('config_image_product_option_width');
		}
		
		if (isset($this->request->post['config_image_product_option_height'])) {
			$data['config_image_product_option_height'] = $this->request->post['config_image_product_option_height'];
		} else {
			$data['config_image_product_option_height'] = $this->config->get('config_image_product_option_height');
		}
		// end
		...
		// myzhou 2.15/5/12 bug修正: config_mail_smtp_hostname �?config_mail_smtp_host
	...
	protected function validate() {
		...
		// myzhou 2015/6/28 添加商品属性图片大小设置
		if (!$this->request->post['config_image_product_option_width'] || !$this->request->post['config_image_product_option_height']) {
			$this->error['image_product_option'] = $this->language->get('error_image_product_option');
		}
