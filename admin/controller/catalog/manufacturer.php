...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_openid_1'] = $this->language->get('entry_openid_1');
		$data['entry_openid_2'] = $this->language->get('entry_openid_2');
		$data['entry_openid_3'] = $this->language->get('entry_openid_3');
		...
		if (isset($this->error['openid_1'])) {
			$data['error_openid_1'] = $this->error['openid_1'];
		} else {
			$data['error_openid_1'] = '';
		}
		...
		// service_zones
		if (isset($this->request->post['manufacturer_service_zone'])) {
			$data['manufacturer_service_zone'] = $this->request->post['manufacturer_service_zone'];
		} elseif (isset($this->request->get['manufacturer_id'])) {
			$data['manufacturer_service_zone'] = $this->model_catalog_manufacturer->getManufacturerServiceZones($this->request->get['manufacturer_id']);
		} else {
			$data['manufacturer_service_zone'] = array(0);
		}
		...
		foreach($cities as $city){
			$service_zones = $this->model_localisation_service_zone->getServiceZonesByCity($city['city_id']);
		...
		if (isset($this->request->post['openid_1'])) {
			$data['openid_1'] = $this->request->post['openid_1'];
		} elseif (!empty($manufacturer_info)) {
			$data['openid_1'] = $manufacturer_info['openid_1'];
		} else {
			$data['openid_1'] = '';
		}
		
		if (isset($this->request->post['openid_2'])) {
			$data['openid_2'] = $this->request->post['openid_2'];
		} elseif (!empty($manufacturer_info)) {
			$data['openid_2'] = $manufacturer_info['openid_2'];
		} else {
			$data['openid_2'] = '';
		}
		
		if (isset($this->request->post['openid_3'])) {
			$data['openid_3'] = $this->request->post['openid_3'];
		} elseif (!empty($manufacturer_info)) {
			$data['openid_3'] = $manufacturer_info['openid_3'];
		} else {
			$data['openid_3'] = '';
		}
	...
	protected function validateForm() {
		...
		if (utf8_strlen($this->request->post['openid_1']) != 28) {
			$this->error['openid_1'] = $this->language->get('error_openid');
		}
