...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		// service_zones
		if (isset($this->request->post['category_service_zone'])) {
			$data['category_service_zone'] = $this->request->post['category_service_zone'];
		} elseif (isset($this->request->get['category_id'])) {
			$data['category_service_zone'] = $this->model_catalog_category->getCategoryServiceZones($this->request->get['category_id']);
		} else {
			$data['category_service_zone'] = array(0);
		}
