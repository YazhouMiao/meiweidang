...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_time_end'] = $this->language->get('entry_time_end');
		$data['entry_buyable'] = $this->language->get('entry_buyable');
		...
		$data['button_time_add'] = $this->language->get('button_time_add');
		...
		if (isset($this->request->post['recommended'])) {
			...
			$data['recommended'] = $product_info['recommended'];
		} else {
			$data['recommended'] = 0;
		}
		...
		// Times myzhou 2015/8/31
		if (isset($this->request->post['product_time'])) {
			$data['product_times'] = $this->request->post['product_time'];
		} elseif (isset($this->request->get['product_id'])) {
			$data['product_times'] = $this->model_catalog_product->getProductTimes($this->request->get['product_id']);
		} else {
			$data['product_times'] = array();
		}
		...
		// service_zones
		if (isset($this->request->post['product_service_zone'])) {
			$data['product_service_zone'] = $this->request->post['product_service_zone'];
		} elseif (isset($this->request->get['product_id'])) {
			$data['product_service_zone'] = $this->model_catalog_product->getProductServiceZones($this->request->get['product_id']);
		} else {
			$data['product_service_zone'] = array(0);
		}
