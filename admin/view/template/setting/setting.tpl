        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-default-city-id"><?php echo $entry_default_city_id; ?></label>
                <div class="col-sm-10">
                  <select name="config_default_city_id" id="input-default-city-id" class="form-control">
                    <?php foreach ($cities as $city) { ?>
                    <?php if ($city['city_id'] == $config_default_city_id) { ?>
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-deliverer-group"><span data-toggle="tooltip" title="<?php echo $help_deliverer_group; ?>"><?php echo $entry_deliverer_group; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_deliverer_group_id" id="input-deliverer-group" class="form-control">
                      <?php foreach ($customer_groups as $customer_group) { ?>
                      <?php if ($customer_group['customer_group_id'] == $config_deliverer_group_id) { ?>
                      <option value="<?php echo $customer_group['customer_group_id']; ?>" selected="selected"><?php echo $customer_group['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['name']; ?></option>
                      <?php } ?>
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-weixin-qrcode"><?php echo $entry_weixin_qrcode; ?></label>
                <div class="col-sm-10"><a href="" id="thumb-weixin-qrcode" data-toggle="image" class="img-thumbnail"><img src="<?php echo $weixin_qrcode; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_weixin_qrcode" value="<?php echo $config_weixin_qrcode; ?>" id="input-weixin-qrcode" />
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-product-option"><?php echo $entry_image_product_option; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_product_option_width" value="<?php echo $config_image_product_option_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-location" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_product_option_height" value="<?php echo $config_image_product_option_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_product_option) { ?>
                  <div class="text-danger"><?php echo $error_image_product_option; ?></div>
                  <?php } ?>
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane" id="tab-mail">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <!-- myzhou 2015/5/12 bug修正:config_mail_smtp_hostname �?config_mail_smtp_host -->
