<ul id="menu">
  ...
  <li id="extension"><a class="parent"><i class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo $text_extension; ?></span></a>
    <ul>
      ...
      <?php } ?>
      <!-- 添加微信公众号扩展模块 -->
      <li><a class="parent"><?php echo $text_weixin_extension; ?></a>
        <ul>
          <li><a href="<?php echo $weixin_setting_link; ?>"><?php echo $text_weixin_setting; ?></a></li>
          <li><a class="parent"><?php echo $text_weixin_template_message; ?></a>
            <ul>
              <li><a href="<?php echo $weixin_template_new_order; ?>"><?php echo $text_weixin_template_new_order; ?></a></li>
            </ul>
          </li>
        </ul>
      </li>
      <!-- end -->
      <!-- 支付宝扩展模块 -->
      <li><a class="parent"><?php echo $text_alipay_extension; ?></a>
        <ul>
          <li><a href="<?php echo $alipay_setting_link; ?>"><?php echo $text_alipay_setting; ?></a></li>
        </ul>
      </li>
      <!-- end -->
    </ul>
  ...
  <li id="system"><a class="parent"><i class="fa fa-cog fa-fw"></i> <span><?php echo $text_system; ?></span></a>
    <ul>
      ...
      <!-- add delivery -->
      <li><a class="parent"><?php echo $text_delivery; ?></a>
        <ul>
          <li><a href="<?php echo $delivery_staff; ?>"><?php echo $text_delivery_staff; ?></a></li>
          <li><a href="<?php echo $delivery_schedule; ?>"><?php echo $text_delivery_schedule; ?></a></li>
          <li><a href="<?php echo $delivery_history; ?>"><?php echo $text_delivery_history; ?></a></li>
        </ul>
      </li>
      ...
      <li><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $service_zone; ?>"><?php echo $text_service_zone; ?></a></li>
          <li><a href="<?php echo $delivery_area; ?>"><?php echo $text_delivery_area; ?></a></li>
          ...
          <!-- delete currency/country/zone/geo_zone/tax/length/weight
