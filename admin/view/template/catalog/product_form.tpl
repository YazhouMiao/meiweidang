        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" id="input-title<?php echo $language['language_id']; ?>" class="form-control" />
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-recommended"><?php echo $entry_recommended; ?></label>
                <div class="col-sm-10">
                  <select name="recommended" id="input-recommended" class="form-control">
                    <?php if ($recommended) { ?>
                    <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                    <option value="0"><?php echo $text_no; ?></option>
                    <?php } else { ?>
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_service_zone; ?></label>
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($cities as $city) { ?>
                      <label><?php echo $city['name'] ?></label>
                      <?php if (!empty($city['service_zones'])) { ?>
                      <?php foreach ($city['service_zones'] as $service_zone) { ?>
                        <div class="checkbox">
                          <label>
                            <?php if (in_array($service_zone['service_zone_id'], $product_service_zone)) { ?>
                            <input type="checkbox" name="product_service_zone[]" value="<?php echo $service_zone['service_zone_id']; ?>" checked="checked" />
                            <?php echo $service_zone['service_zone_name']; ?>
                            <?php } else { ?>
                            <input type="checkbox" name="product_service_zone[]" value="<?php echo $service_zone['service_zone_id']; ?>" />
                            <?php echo $service_zone['service_zone_name']; ?>
                            <?php } ?>
                          </label>
                        </div>
            ...
            <div class="tab-pane" id="tab-time">
              <div class="alert alert-success"><i class="fa fa-info-circle"></i> <?php echo $help_time; ?></div>
              <div class="table-responsive">
                <table id="time" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left" style="width: 30%;"><?php echo $entry_time_start; ?></td>
                      <td class="text-left" style="width: 30%;"><?php echo $entry_time_end; ?></td>
                      <td class="text-center"><?php echo $entry_buyable; ?></td>
                      <td></td>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $time_row = 0; ?>
                    <?php foreach ($product_times as $product_time) { ?>
                    <tr id="time-row<?php echo $time_row; ?>">
                      <td class="text-left" style="width: 30%;"><div class="input-group time">
                          <input type="text" name="product_time[<?php echo $time_row; ?>][time_start]" value="<?php echo $product_time['time_start']; ?>" placeholder="<?php echo $entry_time_start; ?>" data-date-format="HH:mm:ss" class="form-control" />
                          <span class="input-group-btn">
                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                          </span></div></td>
                      <td class="text-left" style="width: 30%;"><div class="input-group time">
                          <input type="text" name="product_time[<?php echo $time_row; ?>][time_end]" value="<?php echo $product_time['time_end']; ?>" placeholder="<?php echo $entry_time_end; ?>" data-date-format="HH:mm:ss" class="form-control" />
                          <span class="input-group-btn">
                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                          </span></div></td>
                      <td class="text-left"><select name="product_time[<?php echo $time_row; ?>][buyable]" id="input-required<?php echo $time_row; ?>" class="form-control">
                          <?php if ($product_time['buyable']) { ?>
                          <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                          <option value="0"><?php echo $text_no; ?></option>
                          <?php } else { ?>
                          <option value="1"><?php echo $text_yes; ?></option>
                      ...
                      <td class="text-left"><button type="button" onclick="$('#time-row<?php echo $time_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                    </tr>
                    <?php $time_row++; ?>
                    <?php } ?>
                  </tbody>
                  <tfoot>
                    <tr>
                      <td colspan="3"></td>
                      <td class="text-left"><button type="button" onclick="addTime();" data-toggle="tooltip" title="<?php echo $button_time_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
...
function addTime() {
    ...
    html += '  <td class="text-left" style="width: 30%;"><div class="input-group time"><input type="text" name="product_time[' + time_row + '][time_start]" value="00:00:00" placeholder="<?php echo $entry_time_start; ?>" data-date-format="HH:mm:ss" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
    html += '  <td class="text-left" style="width: 30%;"><div class="input-group time"><input type="text" name="product_time[' + time_row + '][time_end]" value="00:00:00" placeholder="<?php echo $entry_time_end; ?>" data-date-format="HH:mm:ss" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>';
    html += '  <td class="text-left"><select name="product_time[' + time_row + '][buyable]" class="form-control">';
    html += '    <option value="1"><?php echo $text_yes; ?></option>';
    html += '    <option value="0"><?php echo $text_no; ?></option>';
    html += '    </select></td>';
    html += '  <td class="text-left"><button type="button" onclick="$(\'#time-row' + time_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
    html += '</tr>';
