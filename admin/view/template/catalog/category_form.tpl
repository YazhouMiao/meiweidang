                  ...
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($cities as $city) { ?>
                      ...
                      <?php foreach ($city['service_zones'] as $service_zone) { ?>
                        <div class="checkbox">
                          <label>
                            <?php if (in_array($service_zone['service_zone_id'], $category_service_zone)) { ?>
                            <input type="checkbox" name="category_service_zone[]" value="<?php echo $service_zone['service_zone_id']; ?>" checked="checked" />
                            <?php echo $service_zone['service_zone_name']; ?>
                            <?php } else { ?>
                            <input type="checkbox" name="category_service_zone[]" value="<?php echo $service_zone['service_zone_id']; ?>" />
                            <?php echo $service_zone['service_zone_name']; ?>
                            <?php } ?>
                          </label>
                        </div>
