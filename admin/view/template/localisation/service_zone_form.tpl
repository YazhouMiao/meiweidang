    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-service-zone" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-admin-name"><?php echo $entry_admin_name; ?></label>
            <div class="col-sm-10">
              <input type="text" name="admin_name" value="<?php echo $admin_name; ?>" placeholder="<?php echo $entry_admin_name; ?>" id="input-admin-name" class="form-control" />
              <?php if ($error_admin_name) { ?>
              <div class="text-danger"><?php echo $error_admin_name; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
