        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-zone">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'sz.service_zone_name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'sz.service_zone_code') { ?>
              ...
              <tbody>
                <?php if ($service_zones) { ?>
                <?php foreach ($service_zones as $service_zone) { ?>
                <tr>
                  <td class="text-center"><?php if (in_array($service_zone['service_zone_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $service_zone['service_zone_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $service_zone['service_zone_id']; ?>" />
                    <?php } ?></td>
